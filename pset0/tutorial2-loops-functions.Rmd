---
title: "types, functions, and loops in R"
output: html_document
---
Original author: Pablo Barbera (with changes)

This Rmarkdown script provides a description of some of the building blocks we will need to manipulate data. I recommend you run the following code. 

### Data types

R has many data types, but the most common ones we will use are:
...
Have you noticed? R is 1-indexed, not 0-indexed. 
